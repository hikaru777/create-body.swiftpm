            ...
            HStack() {
                ...
                VStack(spacing: 60) {
                    ...
                    if !viewModel.problems.isEmpty {
                        ...
                        .cornerRadius(15)
                        .onTapGesture {
                            viewModel.firstClear.toggle()
                        }
                        .opacity(viewModel.problems.isEmpty ? 1 : 0)
//                        .fullScreenCover(isPresented: $firstClear) {
//                            SecondView()
//                        }
                    }
            ...
            if !viewModel.firstExpress {
                
                BeforePlayingView(viewModel: viewModel)
                    .frame(maxWidth: .infinity, maxHeight: .infinity)
                    .background(.ultraThinMaterial)
                
            }
            
            if viewModel.firstClear {
                
                FinishFirstView(viewModel: viewModel)
                    .frame(maxWidth: .infinity, maxHeight: .infinity)
                    .background(.ultraThinMaterial)
