...
@available(iOS 17.0, *)
struct CreateYoungBodyView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            HStack() {
                ...
                VStack(spacing: 60) {
                    ...
                    if !viewModel.problems.isEmpty {
                        ...
                        .cornerRadius(15)
                        .onTapGesture {
                            viewModel.thirdClear = true
                        }
                        .opacity(viewModel.problems.isEmpty ? 1 : 0)
                    }
                        
                    
                    YoungHumanBody(viewModel: viewModel)
                    ...
                    if isPresented {
                        ...
                        if !viewModel.problems.isEmpty {
                            ...
                            ZStack {
                                ...
                                YoungChartView(viewModel: viewModel, isPresented: $isPresented)
                        ...
                        VStack {
                            ...
                            VStack() {
                                ...
                                YoungSliderView(viewModel: viewModel)
            ...
            if viewModel.thirdClear {
                
                ThirdClearView(viewModel: viewModel)
                    .frame(maxWidth: .infinity, maxHeight: .infinity)
                    .background(.ultraThinMaterial)
